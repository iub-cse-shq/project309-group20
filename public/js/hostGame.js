...
socket.on('gameQuestions', function(data){
    ...
    document.getElementById('playersAnswered').innerHTML = "Student Answered 0 / " + data.playersInGame;
    updateTimer();
});

socket.on('updatePlayersAnswered', function(data){
   document.getElementById('playersAnswered').innerHTML = "Student Answered " + data.playersAnswered + " / " + data.playersInGame; 
});
...
socket.on('GameOver', function(data){
    ...
    document.getElementById('question').innerHTML = "  Done! Thank you for using our Website. Hope you enjoy it!!!! ";
    document.getElementById('playersAnswered').innerHTML = "";
    
    
    document.body.style.backgroundColor = "rgb(65, 209, 60)";
